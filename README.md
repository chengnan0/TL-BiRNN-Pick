...
Usage Instructions
  We provide the complete model after transfer learning. Users can directly perform phase picking on new mining seismic data using the Phase_pick.py script without additional training:
  python TL-BiRNN-Pick/Phase_pick.py
License
